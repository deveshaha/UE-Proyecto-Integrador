...
public class ListaPeliculas {
    ...
    public static ArrayList<Peliculas> getListaPeliculas() {
        ...
        listaPeliculas.add(new Peliculas("PEL5", "M3GAN", "Terror, Ciencia Ficción", 6.4, "Gerard Johnstone","1h 42m",
                "La amistad ha evolucionado un ingeniero en robótica de una empresa de juguetes construye una muñeca realista que comienza a cobrar vida propia.", R.drawable.im_movie_5));
