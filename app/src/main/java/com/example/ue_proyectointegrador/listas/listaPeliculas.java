...
public class listaPeliculas {
    ...
    public static ArrayList<Peliculas> getListaPeliculas() {
        ...
        listaPeliculas.add(new Peliculas("1", "Spider-Man: No Way Home", 147.0, "Acción, Aventura",
        ...
        listaPeliculas.add(new Peliculas("2", "Matrix Resurrections", 148.0, "Acción, Ciencia ficción",
        ...
        listaPeliculas.add(new Peliculas("3", "Dune", 155.0, "Acción, Aventura",
        ...
        listaPeliculas.add(new Peliculas("4", "The French Dispatch", 107.0, "Comedia, Drama",
        ...
        listaPeliculas.add(new Peliculas("5", "The Power of the Dog", 125.0, "Drama, Western",
        ...
        listaPeliculas.add(new Peliculas("6", "Licorice Pizza", 133.0, "Comedia, Drama",
        ...
        listaPeliculas.add(new Peliculas("7", "The Lost Daughter", 120.0, "Drama, Thriller",
        ...
        listaPeliculas.add(new Peliculas("8", "Belfast", 97.0, "Drama",
                "En la década de 1960, un niño crece en Belfast en medio de la violencia sectaria y el cambio social.", "belfast.jpg"));

        listaPeliculas.add(new Peliculas("9", "West Side Story", 156.0, "Drama, Musical",
        ...
        listaPeliculas.add(new Peliculas("10", "Don't Look Up", 138.0, "Comedia, Ciencia ficción",
